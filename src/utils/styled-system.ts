...
export const getPadding =(styles:any,paddingObject:any)=>{
 
  
  paddingObject.args[0].left = {...paddingObject.args[0].left, value: styles["paddingLeft"] ?? styles["padding"] ?? 0};
  paddingObject.args[0].right = {...paddingObject.args[0].right, value: styles["paddingRight"] ?? styles["padding"] ?? 0};
  paddingObject.args[0].top = {...paddingObject.args[0].top, value: styles["paddingTop"] ?? styles["padding"] ?? 0};
...
export const getBorderRadius =(styles:any,object:any)=>{
  ...
  object.args[0].bottomLeft = {...object.args[0].bottomLeft, value:  styles["borderRadius"] ?? 0};
  object.args[0].bottomRight = {...object.args[0].bottomRight, value:  styles["borderRadius"] ?? 0};
  object.args[0].topLeft = {...object.args[0].topLeft, value: styles["borderRadius"] ?? 0};
  object.args[0].topRight = {...object.args[0].topRight, value:  styles["borderRadius"] ?? 0};
